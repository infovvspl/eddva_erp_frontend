...
export default function CreateMenuCategoryPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-slate-900">Create Menu Category</h1>
        <p className="text-slate-600 mt-1">Add a new menu category</p>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex gap-3 pt-4">
              <Button
                type="button"
                variant="ghost"
                onClick={() => navigate('/canteen/menu/categories')}
                disabled={submitting}
              >
                Cancel
              </Button>
