...
export default function PassengerTable({ passengers, className }: PassengerTableProps) {
        ...
        <tbody>
          {passengersArray.length === 0 ? (
            ...
            passengersArray.map((passenger) => (
              <tr key={passenger.passenger_id} className="border-b border-slate-100 hover:bg-slate-50">
                <td className="py-3 px-4">
                  <Link
                    to={`/transport/passengers/${passenger.passenger_id}`}
                ...
                <td className="py-3 px-4 text-sm text-slate-600 capitalize">{passenger.type}</td>
                <td className="py-3 px-4">
                  <span
                    className={cn(
