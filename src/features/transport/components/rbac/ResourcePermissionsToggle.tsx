...
interface ResourcePermissionsToggleProps {
  ...
  selectedPermissions: TransportRolePermissionRule[];
  onChange: (permissions: TransportRolePermissionRule[]) => void;
  className?: string;
}
...
export default function ResourcePermissionsToggle({
  ...
  const toggleAllForResource = (resourceItem: TransportPermissionResourceGroup) => {
