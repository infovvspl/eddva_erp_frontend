...
export default function PermissionsPage() {
  const [permissions, setPermissions] = useState<TransportPermissionEntry[]>([]);
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-600 mt-1">Manage transport permissions registry</p>
        </div>
        <Link to="/transport/permissions/new">
