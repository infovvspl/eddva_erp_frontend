...
import type { Permission } from '../../types/admission.types';
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-600 mt-1">Manage admission permissions registry</p>
        </div>
        <Link to="/admission/permissions/new">
