...
export default function WarehouseTable({ warehouses, className, onDelete }: WarehouseTableProps) {
  return (
        ...
        <tbody>
          {warehouses.length === 0 ? (
            ...
            warehouses.map((warehouse) => (
              <tr key={warehouse.warehouse_id} className="border-b border-slate-100 hover:bg-slate-50">
                ...
                <td className="py-3 px-4">
                  <div className="flex items-center gap-2">
                    <Link to={`/sales-purchase/warehouses/${warehouse.warehouse_id}`}>
                      <button className="p-1.5 hover:bg-slate-100 rounded-lg text-slate-600" title="View">
                        <Eye className="h-4 w-4" />
                      </button>
                    </Link>
                    <Link to={`/sales-purchase/warehouses/${warehouse.warehouse_id}/edit`}>
