...
import { formatCell, isPlainObject, isScalar, sentenceCase } from '../../utils/reportRender';
...
// A map of rows — { "MBA": { count: 60, verified: 41 }, ... } — reads best as a table.
...
// Renders any report or dashboard payload without knowing its shape: rows
// become a table, an object's plain values become stat tiles, and nested
// parts become their own sections.
