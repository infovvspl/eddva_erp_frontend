...
import type { Role, UserAssignmentFormData } from '../../types/alumni.types';
...
export default function CreateUserPage() {
    ...
    return (
      <div className="space-y-6">
        <div>
          ...
          <p className="text-slate-600 mt-1">Assign a user to an alumni role</p>
        </div>
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-slate-900">Assign User</h1>
        <p className="text-slate-600 mt-1">Create an alumni user assignment with login credentials</p>
      </div>
