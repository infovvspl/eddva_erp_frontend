...
import type { PermissionFormData } from '../../types/alumni.types';
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-600 mt-1">Create a new alumni permission</p>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                placeholder="e.g., Allows exporting event records"
                className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                required
              />
            </div>
            ...
            <div className="flex gap-3 pt-4">
              <Button
                type="button"
                variant="ghost"
                onClick={() => navigate('/alumni/permissions')}
                disabled={submitting}
              >
                Cancel
              </Button>
