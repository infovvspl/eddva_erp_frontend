...
import { getPermissions, deletePermission } from '../../api/sports.api';
import { getApiErrorMessage } from '../../utils/rbac.utils';
import type { Permission } from '../../types/sports.types';
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-600 mt-1">Manage sports permissions registry</p>
        </div>
        <Link to="/sports/permissions/new">
