...
import { getHostelRoles, deleteHostelRole } from '../../api/roles.api';
import { getApiErrorMessage } from '../../utils/errors';
import type { HostelRole } from '../../types/role.types';

function countPermissions(role: HostelRole): number {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-900">Hostel Roles</h1>
          <p className="text-slate-600 mt-1">Manage hostel roles and permissions</p>
        </div>
        <Link to="/hostel/roles/new">
                    ...
                    <tr key={role.role_id} className="border-b border-slate-100 hover:bg-slate-50">
                      ...
                      <td className="py-3 px-4 text-right">
                        <div className="flex items-center justify-end gap-2">
                          <Link to={`/hostel/roles/${role.role_id}/edit`}>
