...
interface ResourcePermissionsToggleProps {
  ...
  selectedPermissions: HostelRolePermissionRule[];
  onChange: (permissions: HostelRolePermissionRule[]) => void;
  className?: string;
}
...
export default function ResourcePermissionsToggle({
  ...
  const toggleAllForResource = (resourceItem: HostelPermissionResourceGroup) => {
