...
import type { AccountsPermissionEntry } from '../../types/role.types';

export default function PermissionsPage() {
  const [permissions, setPermissions] = useState<AccountsPermissionEntry[]>([]);
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-600 mt-1">Manage accounts permissions registry</p>
        </div>
        <Link to="/accounts/permissions/new">
