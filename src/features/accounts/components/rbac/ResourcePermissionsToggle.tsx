...
interface ResourcePermissionsToggleProps {
  ...
  selectedPermissions: AccountsRolePermissionRule[];
  onChange: (permissions: AccountsRolePermissionRule[]) => void;
  className?: string;
}
...
export default function ResourcePermissionsToggle({
  ...
  const toggleAllForResource = (resourceItem: AccountsPermissionResourceGroup) => {
