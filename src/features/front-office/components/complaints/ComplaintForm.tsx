...
import { COMPLAINT_CATEGORY_OPTIONS, COMPLAINT_PRIORITY_OPTIONS } from '../../constants/complaint.constants';
...
interface ComplaintFormProps {
  ...
  showPriorityAndAssignee?: boolean;
  submitText?: string;
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <Input
            ...
            onChange={(e) => onChange({ ...formData, complainant_name: e.target.value })}
        ...
        <div>
          ...
          <Input
            list="complaint-category-suggestions"
            value={formData.category}
            onChange={(e) => onChange({ ...formData, category: e.target.value })}
            placeholder="e.g., facilities"
            required
          />
          <datalist id="complaint-category-suggestions">
        ...
        {showPriorityAndAssignee && (
          <div>
            ...
            <Select
              ...
              onChange={(e) => onChange({ ...formData, priority: e.target.value as ComplaintFormData['priority'] })}
