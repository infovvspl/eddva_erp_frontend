...
import { createBook, getCategories } from '../../api/library.api';
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-600 mt-1">Add a new book to the library catalog</p>
      </div>
