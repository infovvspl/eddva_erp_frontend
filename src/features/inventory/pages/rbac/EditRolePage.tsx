...
export default function EditRolePage() {
  ...
  const [selectedPermissions, setSelectedPermissions] = useState<InventoryRolePermissionRule[]>([]);
    ...
    return (
      <div className="space-y-6">
        <div>
          ...
          <p className="text-slate-600 mt-1">Update inventory role and permissions</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex gap-3 pt-4">
              <Button
                type="button"
                variant="ghost"
                onClick={() => navigate('/inventory/roles')}
                disabled={submitting}
              >
                Cancel
              </Button>
