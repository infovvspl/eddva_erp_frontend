...
import type { InventoryRole } from '../../types/role.types';

function countPermissions(role: InventoryRole): number {
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-600 mt-1">Manage inventory roles and permissions</p>
        </div>
        <Link to="/inventory/roles/new">
                    ...
                    <tr key={role.role_id} className="border-b border-slate-100 hover:bg-slate-50">
                      ...
                      <td className="py-3 px-4 text-right">
                        <div className="flex items-center justify-end gap-2">
                          <Link to={`/inventory/roles/${role.role_id}/edit`}>
